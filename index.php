...
<div class="container-fluid">
  ...
  <strong style="display: inline-block;">ALERT/NOTICE :</strong><marquee style="width: 89%;float:right;display: inline-block;">This is new notice.</marquee>
  </div>
  <div class="container-fluid">
    <div class="row">
    <!-- quick links -->
...
<br>
  <div class="row">
    ...
    <div class="col-sm-6">
      <h5>Maintenance Notice</h5><hr>
      <p class="content-para"> Lorem ipsum dolor sit amet, consectetur adipisicing elit,</p>
  ...
  <footer class="footer-content">
   <!--  <div class="container footer-container"> -->
      <div class="row footer-row" >
        <div class="col-lg-4">
          <h6 class="footer-heading">DISCLAIMER</h6>
          <p class="footer-para">All over the internet,  catching visitors like a safety net, before they hit the bottom of the page hard.</p>
          <p class="footer-para">All over the internet, catching visitors like a safety net, before they hit the bottom of the page hard.</p>
        </div>
        <div class="col-lg-4">
          ...
          <a class="footer-links2" id="ftl" href="">RSS</a>
        </div>
        <div class="col-lg-4">
          <h6 class="footer-heading">VISITOR COUNTER</h6>
          <p class="footer-para">Copyright &copy; 2020,ALL rights reserved</p>
          <p class="footer-para">Maintained</p>
        </div>
      </div>
   <!--  </div> -->
  </footer>

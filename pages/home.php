            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="alert alert-warning" role="alert">
                  <strong>there is no events!</strong>
                </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-12 pt-2">
            <div class="card">
              <div class="card-body" id="rightside-card">
                <h5>POLLS</h5>
                <p class="card-contents" >How did you hear about us?</p>
                <p class="card-contents"><input type="radio" name="card"> a. From friends, family members</p>
